...
public class S08_27_DeleteOpportunity extends ParentClass {
	...
	public void sendFileName() {
		...
		workBookName = "DeleteOpportunity";

	}
	
	@Test(dependsOnMethods= {"Sprint1.S08_25_CreateOpportunity.runCreateOpportunity","Sprint1.S08_26_EditOpportunity.runEditOpportunity"},dataProvider="fetchData")
	//public static void main(String[] args) throws InterruptedException {
	public void runDeleteOpportunity(String module, String opportunityName) throws InterruptedException {
